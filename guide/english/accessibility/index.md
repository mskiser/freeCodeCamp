...
Where WAI tackles the semantics of html to more easily nagivate the [DOM Tree](https://en.wikipedia.org/wiki/Document_Object_Model), ARIA attempts to make web apps, especially those developed with javascript and
